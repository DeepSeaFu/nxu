<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(https://img1.baidu.com/it/u=3217765370,3535423635&fm=253&fmt=auto&app=138&f=JPG?w=889&h=500)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
...
<style lang="scss" scoped>
	.container {
	  position: relative;
	  background: url(https://img1.baidu.com/it/u=3217765370,3535423635&fm=253&fmt=auto&app=138&f=JPG?w=889&h=500);
