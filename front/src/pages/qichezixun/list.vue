...
<script>
  export default {
    ...
    methods: {
      ...
      getHotList() {
        let autoSortUrl = "";
        autoSortUrl = "qichezixun/autoSort1";
...
<style rel="stylesheet/scss" lang="scss" scoped>
	...
	.category-1 .item:hover {
		...
		margin: 0 10px 0 0;
		color: #fff;
		background: url(https://bpic.51yuansu.com/backgd/cover/00/00/09/5b45dce3a1138.jpg?x-oss-process=image/resize,h_360,m_lfit/sharpen,100) no-repeat;
		width: 130px;
		font-size: 14px;
		line-height: 40px;
		text-align: center;
	...
	.category-1 .item.active {
		...
		margin: 0 10px 0 0;
		color: #fff;
		background: url(https://img0.baidu.com/it/u=4083127476,826409349&fm=253&fmt=auto&app=120&f=JPEG?w=800&h=400) no-repeat;
		width: 130px;
		font-size: 14px;
		line-height: 40px;
		text-align: center;
