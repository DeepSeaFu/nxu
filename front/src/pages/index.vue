<template>
	<div class="main-containers">
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0px","margin":"0 auto","overflow":"hidden","alignItems":"center","background":"url(https://img2.baidu.com/it/u=2886397962,2592882946&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400) fixed","display":"flex","width":"100%","position":"relative","justifyContent":"space-around","height":"75px","zIndex":"1002"}'>
			<img v-if='false' :style='{"width":"44px","objectFit":"cover","borderRadius":"100%","display":"block","height":"44px"}' src='https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400'>
		...
		<div class="body-containers" :style='"horizontal" == "vertical" ? {"minHeight":"100vh","padding":"64px 0 0","margin":"0 0 0 210px","position":"relative","background":"rgba(64, 158, 255, .3)","display":"block"} : {"minHeight":"100vh","padding":"0","margin":"0","position":"relative","background":"url(https://img2.baidu.com/it/u=2886397962,2592882946&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400) fixed"}'>
			<div class="menu-preview" :style='{"padding":"0 20px","borderColor":"#efefef","textAlign":"center","background":"url(https://bpic.51yuansu.com/backgd/cover/00/13/40/5b7dff154c298.jpg?x-oss-process=image/resize,h_360,m_lfit/sharpen,100) repeat-x","borderWidth":"0 0 0px 0","width":"100%","borderStyle":"solid","height":"auto"}'>
				<el-menu class="el-menu-horizontal-demo" :style='{"border":0,"padding":"0","margin":"0 auto","borderColor":"#006fc3","alignItems":"flex-end","display":"flex","justifyContent":"center","listStyle":"none","overflow":"hidden","flexWrap":"wrap","background":"none","borderWidth":"0px 1px 0px 0px","width":"100%","position":"relative","borderStyle":"solid","height":"40px"}' :default-active="activeIndex" :unique-opened="true" mode="horizontal" :router="true" @select="handleSelect">
					<el-image v-if="false" :style='{"width":"44px","margin":"8px 10px 8px 0","objectFit":"cover","borderRadius":"100%","float":"left","height":"44px"}' src="https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400" fit="cover"></el-image>
			...
			<div class="bottom-preview" :style='{"minHeight":"150px","padding":"20px 0","alignItems":"center","color":"#fff","background":"url(https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400) #034281 repeat-x","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center"}'>
			    <img :style='{"width":"44px","objectFit":"cover","borderRadius":"100%","display":"none","height":"44px"}' src="https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400" >
...
<style rel="stylesheet/scss" lang="scss" scoped>
	...
	.menu-preview .el-menu-horizontal-demo .el-menu-item:hover {
		...
		border-color:  #00254a #00254a #006fc3 #006fc3;
		line-height: 40px;
		background: url(https://img95.699pic.com/xsj/01/vb/j8.jpg%21/fh/300) no-repeat;
		width: 120px;
		border-width: 0px 0px 0px 1px;
		position: relative;
		border-style: solid;
