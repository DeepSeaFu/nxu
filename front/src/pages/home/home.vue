...
<div class="home-preview" :style='{"width":"1200px","margin":"20px auto 20px","flexWrap":"wrap","justifyContent":"space-between","display":"flex"}'>
	...
	<div :style='{"border":"1px solid #dfdfdf","padding":"20px","boxShadow":"1px 2px 3px #eee","margin":"20px 0 20px","overflow":"hidden","borderRadius":"16px","background":"#fff","width":"100%","position":"relative","height":"auto","order":"5"}'>
	  <div :style='{"margin":"12px 0 0 0","color":"#005aad","textAlign":"center","background":"url(https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400) no-repeat 240px bottom,url(https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400) no-repeat 760px bottom","width":"100%","lineHeight":"1.5","fontSize":"24px","textShadow":"2px 4px 2px #eee","fontWeight":"bold"}'>{{systemIntroductionDetail.title}}</div>
...
<div class="recommend" :style='{"border":"1px solid #dfdfdf","boxShadow":"1px 2px 3px #eee","margin":"20px 0 80px","overflow":"hidden","borderRadius":"16px","background":"#fff","width":"100%","height":"auto","order":"1"}'>
    ...
    <div class="title" :style='{"width":"100%","margin":"24px 0 24px 0","lineHeight":"1.5","textAlign":"center"}'>
...
<div class="recommend" :style='{"border":"1px solid #dfdfdf","boxShadow":"1px 2px 3px #eee","margin":"20px 0 80px","overflow":"hidden","borderRadius":"16px","background":"#fff","width":"100%","height":"auto","order":"1"}'>
    ...
    <div class="title" :style='{"width":"100%","margin":"24px 0 24px 0","lineHeight":"1.5","textAlign":"center","background":"url(https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400) no-repeat 240px center,url(http://codegen.caihongy.cn/20221027/6602c4fb09df4bd4881cabfef19d2ed3.png) no-repeat 760px center"}'>
...
<div class="news" :style='{"border":"1px solid #dfdfdf","padding":"20px","boxShadow":"1px 2px 3px #eee","margin":"0 0 80px","overflow":"hidden","borderRadius":"16px","background":"#fff","width":"49%","height":"660px","order":"2"}'>
	...
	<div class="title" :style='{"width":"100%","margin":"24px 0 24px 0","lineHeight":"1.5","textAlign":"center","background":"url(https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400) no-repeat -70px bottom,url(https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400) no-repeat 400px bottom"}'>
	...
	<div :style='{"border":"1px solid #dfdfdf","padding":"20px","boxShadow":"1px 2px 3px #eee","margin":"0px 0 20px","overflow":"hidden","borderRadius":"16px","background":"#fff","width":"49%","height":"660px","order":"1"}'>
	  <div :style='{"margin":"12px 0 0 0","color":"#005aad","textAlign":"center","background":"url(https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400) no-repeat -70px bottom,url(http://codegen.caihongy.cn/20221027/6602c4fb09df4bd4881cabfef19d2ed3.png) no-repeat 400px bottom","width":"100%","lineHeight":"1.5","fontSize":"24px","textShadow":"2px 4px 2px #eee","fontWeight":"bold"}'>{{aboutUsDetail.title}}</div>
	  ...
	  <div :style='{"width":"285px","background":"url(\"https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400\") 0% 0% / cover no-repeat","display":"none","height":"100px"}' />
	  <div :style='{"width":"285px","background":"url(\"https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400\") 0% 0% / cover no-repeat","display":"none","height":"100px"}' />
	  <div :style='{"width":"285px","background":"url(\"https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400\") 0% 0% / cover no-repeat","display":"none","height":"100px"}' />
	  <div :style='{"width":"285px","background":"url(\"https://img0.baidu.com/it/u=2069261331,1392808563&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=400\") 0% 0% / cover no-repeat","display":"none","height":"100px"}' />
	</div>
  ...
  export default {
    ...
    methods: {
      ...
      getSystemIntroduction() {
		...
		getList() {
          let autoSortUrl = "";
          autoSortUrl = "qichexinxi/autoSort3";
